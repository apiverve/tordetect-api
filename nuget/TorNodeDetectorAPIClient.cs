...
namespace APIVerve.API.TorNodeDetector
{
    ...
    /// <summary>
    /// Client for the TorNodeDetector API
    /// </summary>
    public class TorNodeDetectorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/tordetect";
        ...
        public TorNodeDetectorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TorNodeDetectorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TorNodeDetectorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TorNodeDetectorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TorNodeDetectorQueryOptions options)
        {
        ...
        public ResponseObj Execute(TorNodeDetectorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TorNodeDetectorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TorNodeDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TorNodeDetectorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TorNodeDetectorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TorNodeDetectorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TorNodeDetectorQueryOptions options)
        {
