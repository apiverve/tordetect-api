...
```gradle
dependencies {
    implementation 'com.github.apiverve:tordetect-api:1.1.13'
}
```
...
```java
import com.apiverve.tordetect.TorNodeDetectorAPIClient;
import com.apiverve.tordetect.APIResponse;
import com.apiverve.tordetect.APIException;

// Initialize the client
TorNodeDetectorAPIClient client = new TorNodeDetectorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("ip", "185.189.183.143");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/tordetect](https://docs.apiverve.com/ref/tordetect)
...
- **Documentation:** [https://docs.apiverve.com/ref/tordetect](https://docs.apiverve.com/ref/tordetect)
- **Issues:** [GitHub Issues](https://github.com/apiverve/tordetect-api/issues)
